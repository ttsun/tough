# NOAH Specific Settings
# Change these to change branding settings
APP_NAME = "TOUGH"
APP_FILES = [
]
EXE_CHOICES = (
    # Format: (EXECUTABLE PATH, DISPLAY NAME)
...
# Django settings for noah_tough project.
import os.path
import logging
...
DATABASES = {
    'default': {
        ...
        'NAME': 'toughdb',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'id=k!mu=$c+97qydl#4_s@qe4w2f#d!lbzde59-wxdgi=0(q&!'
...
ROOT_URLCONF = 'noah_tough.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'noah_tough.wsgi.application'
...
AUTHENTICATION_BACKENDS=(
    'usermanage.backends.NEWTBackend',
    'django.contrib.auth.backends.ModelBackend',
)


LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = NOAH_HOME_URL
LOGOUT_URL = NOAH_HOME_URL + '/logout/'
